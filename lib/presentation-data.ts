...
export const partners: Record<string, PartnerConfig> = {
  ...
  'galvin-green': {
    ...
    heroHeadline: 'GolfN x Galvin Green: Premium Sweepstakes Kickoff',
    heroSubtitle: 'Prepared for Lou Delfino, Natalie Collard & Bryce Ritchie -- March 2026. A high-impact sweepstakes program showcasing the 2026 ARLO GORE-TEX system, Masters limited-edition capsule, and multi-layer education. Brand provides prize bundles only (under $5,000 total value per campaign). Low cost of entry with ability to scale.',
    howItWorksIntro: 'We launch a coordinated Galvin Green sweepstakes program as the perfect US awareness kickoff -- premium positioning without discounting, exactly what matters for the brand.',
  ...
  'sports-impact': {
    ...
    portfolioBrands: [
      { slug: 'galvin-green', name: 'Galvin Green', logoUrl: 'https://cdn.sanity.io/images/e3wja34v/production/6bbe863fced77a5f36904db460f7ed06a3a0e782-230x46.webp', color: '#17A455', category: 'Premium Golf Outerwear', products: ['GORE-TEX Jackets', 'Interface Layers', 'Base Layers', 'Accessories'], pitch: 'Brand awareness and technical education for a premium Swedish outerwear brand expanding US recognition.', targetingEdge: 'GolfN knows which golfers play in rain, wind, and cold -- and targets only climates where technical outerwear matters.' },
      { slug: 'motocaddy', name: 'MotoCaddy', logoUrl: MOTOCADDY_LOGO, color: '#0066CC', category: 'Electric Golf Trolleys', products: ['M7 GPS', 'M5 GPS', 'S1 DHC', 'Cube Push Trolley'], pitch: 'Precision targeting for a high-ticket product. Walk-vs-ride data means every impression goes to a verified walker.', targetingEdge: 'GolfN is the only platform that knows which golfers walk. Every MotoCaddy impression goes to a verified walker -- zero waste.' },
      { slug: 'wilson-golf', name: 'Wilson Golf', logoUrl: 'https://cdn.sanity.io/images/e3wja34v/production/dea5a3da06394dc9f1d779c94d3d75e847ba623f-807x200.svg', color: '#C41E3A', category: 'Golf Equipment', products: ['Dynapower Drivers', 'Staff Model Irons', 'Triad Golf Balls', 'Quiver Stand Bags'], pitch: 'Full-funnel activation for equipment launches. GolfN tracks what clubs users play and when they last upgraded.', targetingEdge: 'GolfN tracks what clubs users play, when they last upgraded, and their handicap range -- so Wilson campaigns reach golfers ready to switch.' },
    ],
    commerceNotes: [
  ...
  'wilson-golf': { slug: 'wilson-golf', partnerName: 'Wilson Golf', password: 'wilson2026', logoUrl: 'https://cdn.sanity.io/images/e3wja34v/production/dea5a3da06394dc9f1d779c94d3d75e847ba623f-807x200.svg', primaryColor: '#C41E3A', secondaryColor: '#E8344E', productCategory: 'Golf Equipment', productNames: ['Dynapower Drivers', 'Staff Model Irons', 'Triad Golf Balls', 'Quiver Stand Bags'], agencyName: 'Sports Impact', agencyLogoUrl: 'https://cdn.sanity.io/images/e3wja34v/production/70846939f70fe368db2cd0c03686d96aa31e5bab-769x186.png', keyMarkets: ['United States', 'United Kingdom', 'Australia', 'Canada'] },
...
export const strategicSummary = [{ lead: 'Brands deserve more than impressions.', body: 'They deserve measurable progression. GolfN delivers all eight stages.' }, { lead: 'The economics are aligned.', body: 'GolfN succeeds when the partner succeeds.' }, { lead: 'Brands already pay for these functions.', body: 'GolfN consolidates them into one coordinated system built around verified golfers.' }]
