...
export type BusinessNeedId = 'fill-capacity' | 'product-trial' | 'educate-market' | 'precision-targeting' | 'market-share' | 'social-growth'
...
export const businessNeeds: BusinessNeed[] = [
  ...
  },
  {
    ...
    capabilities: [
      'Daily Grind check-ins at demo days and fittings',
      'Triple-point incentives for verified attendance',
      'Targeted push to golfers near event locations',
      'Post-trial follow-up with affiliate attribution',
      'Equipment-readiness targeting (due for upgrade)',
    ],
    activationMethods: ['Daily Grind Check-ins', 'Sweepstakes', 'Targeted Ads', 'Affiliate Commerce'],
    icon: '\ud83c\udfcc\ufe0f',
    suggestedSpendModel: 'cpa',
    campaignVariant: {
      title: 'Demo Day + Trial Activation',
      subtitle: 'Get golfers to show up, try your product, and convert',
      description: 'GolfN drives verified attendance to your demo days, fittings, and retail events. Golfers earn points for check-ins. Post-trial, GolfN follows up with the interest cohort using targeted offers and affiliate-tracked purchase paths.',
      prizeIdea: 'The product itself. Full custom fitting, flagship product set, or gear package for top-tier prizes. Accessory bundles for runners-up.',
      activationSteps: [
        'Upload demo day schedule and locations',
        'GolfN pushes targeted notifications to golfers near each event',
        'Golfers check in via Daily Grind and earn 3x points',
        'Post-trial follow-up converts interest into tracked purchases',
      ],
    },
    howItWorksOverrides: [
    ...
    benchmarks: [
      { label: 'Demo Day Flyer + Promo', value: 35 },
      { label: 'Facebook Event Promotion', value: 22 },
      { label: 'Retail Co-op Spend', value: 50 },
    ],
    checklistItems: [
    ...
    impactCriteria: [
      'X verified demo day or fitting attendees',
      'Y trial-to-purchase conversions (attributed)',
      'Z% post-trial engagement rate in follow-up campaigns',
    ],
  },
  {
    id: 'educate-market',
    ...
    capabilities: [
      'Learn and Earn video education modules',
    ...
    suggestedSpendModel: 'cpa',
    campaignVariant: {
      title: 'Learn and Earn Education Campaign',
      subtitle: '2,000 golfers provably learn about your product',
      description: 'GolfN runs a Learn and Earn module where golfers watch your brand content, answer a quiz proving they understood it, and unlock points plus exclusive offers. This is not awareness. This is verified comprehension at scale.',
      prizeIdea: 'Points for completion, exclusive first-access offers, product bundles for top performers.',
      activationSteps: [
        'Provide brand video content or GolfN produces it',
        'GolfN builds quiz verifying product comprehension',
        'Golfers complete module, earn points, unlock offers',
        'Post-education cohort receives targeted conversion offers',
      ],
    },
    howItWorksOverrides: [
    ...
    benchmarks: [
      { label: 'Webinar CPL', value: 45 },
      { label: 'Content Syndication CPL', value: 30 },
      { label: 'Trade Show Cost Per Lead', value: 120 },
    ],
    checklistItems: [
    ...
    impactCriteria: [
      'X golfers completed Learn and Earn module',
      'Y% quiz pass rate (verified comprehension)',
      'Z conversions from educated cohort within 60 days',
    ],
  },
  {
    ...
    capabilities: [
      ...
      'Custom segmentation by spending behavior',
    ],
    activationMethods: ['Targeted Ads', 'Sweepstakes', 'Content & Social', 'Exclusive Access'],
    icon: '\ud83d\udc8e',
    suggestedSpendModel: 'audience',
    campaignVariant: {
      title: 'Premium-Filtered Awareness Campaign',
      subtitle: 'Only golfers who meet your criteria see this campaign',
      description: 'GolfN filters the full user base down to golfers matching your ideal profile: equipment tier, spending behavior, course preferences, geography. Your campaign reaches only high-value individuals. Zero impressions wasted on golfers who will never convert.',
      prizeIdea: 'Premium experiences: exclusive resort access, VIP tournament packages, custom fittings, luxury gear bundles.',
      activationSteps: [
        'Define target criteria (spend, equipment, geography, behavior)',
        'GolfN filters audience to matching high-value golfers',
        'Launch campaign visible only to qualified individuals',
        'Track engagement and conversion from premium cohort',
      ],
    },
    howItWorksOverrides: [
      ...
      { whyDifferent: 'Most premium targeting is demographic guessing. GolfN is behavioral proof. They do not just look wealthy. They spend like it.', metric: '53%', metricLabel: 'avg MoM power user growth' },
    ],
    benchmarkLabel: 'Cost Per High-Value Golfer Identified',
    benchmarks: [
      { label: 'Wealth-Targeted Programmatic', value: 65 },
      { label: 'Luxury Print Media', value: 85 },
      { label: 'Private Club Mailing Lists', value: 40 },
    ],
    checklistItems: [
    ...
    impactCriteria: [
      'X high-value golfers identified matching your criteria',
      'Y engaged at your target spending tier',
      'Z% conversion to booking, membership, or purchase',
    ],
  },
  {
    id: 'market-share',
    ...
    capabilities: [
      'Equipment profile analysis (current gear, competitor ID)',
    ...
    campaignVariant: {
      title: 'Competitive Switching Campaign',
      subtitle: 'Target golfers playing competitor products who are due for an upgrade',
      description: 'GolfN identifies golfers using a competitor in your category or golfers whose current gear is aging. Education explains why your product is better. Incentives lower the switching cost. Attribution tracks every conversion.',
      prizeIdea: 'Your flagship product as the prize. Switching incentives: trade-in bonuses, points-back on first purchase, exclusive launch pricing.',
      activationSteps: [
        'Define competitor products and upgrade cycle criteria',
        'GolfN identifies golfers matching the switching profile',
        'Learn and Earn educates on why your product is better',
        'Conversion incentives drive measurable competitive switches',
      ],
    },
    howItWorksOverrides: [
    ...
    benchmarks: [
      { label: 'Google Brand Competitor Keywords', value: 12 },
      { label: 'Meta Competitive Audience', value: 28 },
      { label: 'Trade-in Program Acquisition', value: 55 },
    ],
    checklistItems: [
      ...
      { id: 'education', label: 'Educational content or brief', detail: 'Why your product is better. Video, talking points, or brief for GolfN to produce.', required: true },
      ...
      { id: 'incentive', label: 'Switching incentive structure', detail: 'Trade-in bonus, discount code, or points-back offer for switchers.', required: false },
    ],
    impactCriteria: [
      'X golfers targeted playing competitor products',
      'Y completed education on your product',
      'Z competitive switches attributed within 60 days',
    ],
  },
  {
    id: 'social-growth',
    ...
    suggestedSpendModel: 'cpa',
    campaignVariant: {
      title: 'OAuth Follower Growth Campaign',
      subtitle: '5,000 verified golfer followers in 30 days',
      description: 'GolfN incentivizes golfers to follow your brand on social platforms through the points economy. OAuth verification ensures every follower is a real, verified golfer on the platform. Success-based pricing means you pay for results.',
      prizeIdea: 'Points for following, bonus points for engagement. Product giveaways for top engagers.',
      activationSteps: [
        'Connect social handles and define follower goals',
        'GolfN launches follow-for-points campaign to matched golfers',
        'OAuth verification confirms every follow is genuine',
    ...
    benchmarks: [
      { label: 'Instagram Growth Services', value: 8 },
      { label: 'Influencer Cost Per Follower', value: 12 },
      { label: 'Paid Social Follower Campaigns', value: 5 },
    ],
    checklistItems: [
    ...
    impactCriteria: [
      'X verified golfer followers gained',
      'Y% engagement rate on new follower cohort',
      '$Z effective cost per verified follower achieved',
    ],
  },
]
