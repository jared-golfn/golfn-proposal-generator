...
// Campaign creative assets for the partner presentation template
export const images = {
  // GolfN branding
  ...
  // App screenshots (off-course, daily grind, marketplace)
  ...
  // Points exchange / marketplace examples
  ...
  // Blog / editorial example
  blogEditorial: 'https://cdn.sanity.io/images/e3wja34v/production/5b145a5d4ea91ba815d2c950ff49470a44467411-1300x1056.png',
  ...
  // Miura logo — M + wordmark PNG from miuragolf.com (their Shopify CDN).
  // Used on the /8am partner page (MiuraResults section + hero nav pill).
...
export const galleryAssets = {
  sweepstakes: [
    { src: images.cobraSweeps, alt: 'Cobra sweepstakes campaign' },
    { src: images.cobraOptmDriver, alt: 'Cobra driver campaign' },
    { src: images.miuraWedgeSweeps, alt: 'Miura wedge sweepstakes' },
    { src: images.wekopaSweeps, alt: 'We-Ko-Pa resort sweepstakes' },
  ],
  email: [
    { src: images.emailSweepsAnnouncement, alt: 'Sweepstakes announcement email' },
    { src: images.emailNewProductDrop, alt: 'New product drop email' },
    { src: images.emailIntentFollowUp, alt: 'Intent follow-up email' },
  ],
  inApp: [
    { src: images.inAppMsg1, alt: 'In-app campaign message' },
    { src: images.inAppMsg2, alt: 'In-app notification' },
    { src: images.inAppMsg3, alt: 'In-app engagement' },
    { src: images.inAppMsg4, alt: 'In-app offer' },
  ],
  banners: [
    { src: images.affiliateBanner1, alt: 'Affiliate banner' },
    { src: images.affiliateBanner2, alt: 'Campaign banner' },
  ...
  pointsExchange: [
    ...
    { src: images.miuraPointsExchange, alt: 'Miura points exchange' },
    { src: images.bettinardiPointsExchange, alt: 'Bettinardi points exchange' },
    { src: images.cobraPointsExchange, alt: 'Cobra points exchange' },
  ],
} as const
