...
export function HypericeFooter() {
  return (
    <footer className="py-16 md:py-20 border-t border-[#2a3347]/40 bg-[#0a0d12]">
      <div className="max-w-7xl mx-auto px-6 md:px-12 text-center">
        <motion.div initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
          ...
          <p className="text-sm text-[#9ca3af] mb-2">Prepared for <span className="text-white font-semibold">Hyperice</span> &middot; May 2026 &middot; v2</p>
          ...
          <p className="text-xs text-[#4b5563]">Data sources: Amplitude Analytics, Braze CRM, Shopify Sales by Product, GolfN Sweepstakes Admin</p>
        </motion.div>
      </div>
    </footer>
  )
