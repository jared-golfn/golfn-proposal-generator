                    ...
                    {cv.activationSteps.map((step, i) => (
                      <div key={i} className="flex gap-4">
                        <div className="flex flex-col items-center">
                          <div className="w-8 h-8 rounded-full bg-[#00ff9d]/15 flex items-center justify-center text-sm font-bold text-[#00ff9d] shrink-0">
                            {i + 1}
                          </div>
                          {i < cv.activationSteps.length - 1 && <div className="w-px h-full bg-[#2a3347] my-1" />}
                        </div>
                        <div className="pb-5">
                          <p className="text-sm text-[#d1d5db] leading-6">{step}</p>
                        </div>
                      </div>
                    ))}
                  </div>
