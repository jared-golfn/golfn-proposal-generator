...
const faqGroups = [
  ...
  { group: 'Reporting and Management', items: [
    ...
    { q: 'Why is there an ongoing management fee?', a: 'After the initial 30-day included period, ongoing management covers reporting, creative refreshes (up to 3 variants per message), message testing, cohort expansion, and continued program optimization. It is billed monthly per qualified user added to your cohort (First 2,000 at $5/user, 2,001 to 5,000 at $3.50, 5,001 to 10,000 at $2, 10,001+ at $1).' },
  ]},
  { group: 'Pricing and Economics', items: [
    { q: 'How does pricing work?', a: 'You provide the sweepstakes prize budget (recommended $5,000 for strongest cohort). GolfN charges a one-time startup fee of $2,500 to $7,500 (tiered by extras: executive endorsement, custom creative, AI lookalike, priority support). Launch campaign execution is included in startup. 30 days post-campaign follow-up is free. After that, ongoing management is billed monthly per qualified user: First 2,000 at $5.00, 2,001 to 5,000 at $3.50, 5,001 to 10,000 at $2.00, 10,001+ at $1.00.' },
    { q: 'What is the startup fee?', a: 'A one-time fee of $2,500 to $7,500 that covers strategy, offer design, audience definition, tracking logic, campaign implementation, full creative asset creation, and the first 30 days of post-campaign follow-up. Tiered by add-ons: executive endorsement module, custom creative packages, AI lookalike audience expansion, and priority account support.' },
