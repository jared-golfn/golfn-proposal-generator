  ...
  return (
    <section className="py-24 md:py-32">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <Fade delay={0.05}>
            <div className="bg-[#1a1f2e] border border-[#2a3347] rounded-xl p-8">
              <h3 className="text-2xl md:text-3xl font-semibold text-white mb-5">Initial Interest Signals</h3>
          ...
          <Fade delay={0.1}>
            <div className="bg-[#1a1f2e] border border-[#2a3347] rounded-xl p-8" style={{ borderLeftWidth: 2, borderLeftColor: '#00ff9d' }}>
              <div className="flex items-center gap-2 mb-5">
                <TrendingUp className="w-6 h-6 text-[#00ff9d]" />
                <h3 className="text-2xl md:text-3xl font-semibold text-white">Stronger Intent Signals</h3>
              </div>
              <div className="flex flex-wrap gap-2">
        ...
        <Fade delay={0.15}>
          <div className="bg-[#1a1f2e] border border-[#2a3347] rounded-xl p-8 mb-6">
        ...
        <Fade delay={0.2}>
          <div className="bg-[#1a1f2e] border-l-2 border-[#00ff9d] rounded-r-xl p-8">
            ...
            <p className="text-lg text-[#d1d5db] leading-8 mb-3">
              The quality of the initial prize or offer affects both campaign participation and the strength of the behavioral signal generated.
            </p>
