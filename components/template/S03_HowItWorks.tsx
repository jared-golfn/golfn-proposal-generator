      ...
      <div className="max-w-7xl mx-auto px-5 md:px-12">
        ...
        <AnimatePresence>
          {expanded && (
            ...
            >
              <div className="bg-[#1a1f2e] border border-[#2a3347] rounded-2xl p-6 md:p-8 mt-4">
                <h4 className="text-xl font-semibold text-white mb-3">{steps.find(s => s.num === expanded)?.title}</h4>
