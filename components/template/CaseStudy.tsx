      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <Fade delay={0.06}>
          <div className="bg-[#1a1f2e] border border-[#2a3347] rounded-2xl px-8 py-7 mb-12">
            ...
            <p className="text-sm text-[#6b7280]">Anthony Newville, President \u2014 Miura Golf \u00b7 May 5, 2026 Partnership Review</p>
          </div>
        </Fade>
        <Fade delay={0.08}>
          <div className="mb-16">
            ...
            <div className="bg-[#1a1f2e] border border-[#2a3347] rounded-2xl overflow-hidden">
              ...
              <div className="px-6 md:px-8 py-6 border-t border-[#2a3347]">
                ...
                <div className="flex items-center gap-3 flex-wrap">
                  ...
                  <ArrowRight className="w-5 h-5 text-[#00ff9d] shrink-0" />
                  <div className="bg-[#0f1217] border border-[#2a3347]/60 rounded-xl px-5 py-4 text-center flex-1 min-w-[140px]"><p className="text-xs text-[#6b7280] mb-1">Industry Avg.</p><p className="text-2xl font-mono font-bold text-[#4b5563]">2\u20135%</p><p className="text-xs text-[#6b7280]">landing page</p></div>
                </div>
              </div>
              ...
              <div className="px-6 md:px-8 py-6 border-t border-[#2a3347]">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="text-center"><p className="text-2xl font-mono font-bold text-white">67%</p><p className="text-xs text-[#9ca3af]">Handicap 10\u201324</p></div>
        ...
        <Fade delay={0.1}>
          <div className="mb-16">
            ...
            <div className="bg-[#1a1f2e] border border-[#2a3347] rounded-2xl overflow-hidden">
              <div className="px-6 md:px-8 py-6">
                <p className="text-base text-[#d1d5db] leading-7 mb-6">Miura launched in the GolfN Points Exchange eight days before the sweepstakes closed. The sweep-to-commerce pipeline worked exactly as designed: golfers who entered the sweepstakes and didn't win found Miura products available for purchase with points. The day after the sweepstakes closed was Miura's single highest-traffic day.</p>
              ...
              <div className="px-6 md:px-8 py-6 border-t border-[#2a3347]">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-sm">
                    ...
                    <tbody>
                      {topProducts.map((p) => (<tr key={p.name} className="border-b border-[#2a3347]/30"><td className="py-3 pr-4 text-[#d1d5db] font-medium">{p.name}</td><td className="py-3 pr-4 text-[#6b7280]">{p.type}</td><td className="py-3 pr-4 text-right font-mono text-white">{p.units}</td><td className="py-3 text-right font-mono text-[#00ff9d] font-semibold">{p.revenue}</td></tr>))}
                      <tr className="border-t-2 border-[#00ff9d]/20"><td className="py-3 pr-4 text-white font-bold">Total</td><td className="py-3 pr-4"></td><td className="py-3 pr-4 text-right font-mono text-white font-bold">45</td><td className="py-3 text-right font-mono text-[#00ff9d] font-bold">$31,780</td></tr>
                    </tbody>
                  </table>
                </div>
              ...
              <div className="px-6 md:px-8 py-6 border-t border-[#2a3347] bg-[#0f1217]">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div><h4 className="text-sm font-mono uppercase tracking-wider text-[#6b7280] mb-2">Operations</h4><p className="text-sm text-[#d1d5db] leading-6">97% of orders submitted into Miura's system without issues. Most shipped within two weeks. Two sellouts were same-day timing \u2014 not process failures.</p></div>
                  <div><h4 className="text-sm font-mono uppercase tracking-wider text-[#6b7280] mb-2">Post-Sweep Commerce</h4><p className="text-sm text-[#d1d5db] leading-6">Marketplace banner captured 271,393 impressions over 27 days \u2014 $10,856 in display ad value at $40 CPM. Peak: 398 product views the day after the sweepstakes closed.</p></div>
