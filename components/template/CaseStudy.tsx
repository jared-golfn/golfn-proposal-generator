        ...
        <Fade delay={0.14}>
          <div className="mt-12 bg-[#1a1f2e] border border-[#2a3347] rounded-2xl overflow-hidden">
            ...
            <div className="px-6 md:px-8 py-5 flex items-center justify-between">
              <div>
                <p className="text-sm font-semibold text-white">L.A.B. Golf — $44,692 in 5 months</p>
                <p className="text-xs text-[#6b7280]">Another partner. Same playbook. 90 premium putters at ~$497 average order.</p>
              </div>
