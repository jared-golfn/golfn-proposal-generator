...
const activationPaths = [
  ...
  },
  {
    ...
    badges: ['Commerce-Enabled', '30% Margin Required'],
    ...
    <section className="py-20 md:py-32">
      <div className="max-w-7xl mx-auto px-5 md:px-12">
        <Fade>
          ...
          <p className="text-lg md:text-xl text-[#9ca3af] max-w-2xl leading-8 mb-6">
        ...
        <Fade delay={0.05}>
          <div className="mb-8 bg-[#1a1f2e] border border-[#2a3347] rounded-xl px-5 py-4 flex items-start gap-3">
        ...
        <Fade delay={0.08}>
          <div className="flex flex-wrap gap-2 mb-8">
            <button
              ...
              className={`text-base font-medium px-4 py-2 rounded-full border transition-all ${!activeGoal ? 'bg-[#00ff9d] text-[#0f1217] border-[#00ff9d]' : 'border-[#2a3347] text-[#9ca3af] hover:border-[#00ff9d]/50'}`}
            >
              All
            </button>
            {goals.map(g => (
              <button
                ...
                className={`text-base font-medium px-4 py-2 rounded-full border transition-all ${activeGoal === g.id ? 'bg-[#00ff9d] text-[#0f1217] border-[#00ff9d]' : 'border-[#2a3347] text-[#9ca3af] hover:border-[#00ff9d]/50'}`}
              >
                {g.label}
              </button>
            ))}
          ...
          {visiblePaths.map((path, i) => {
            ...
            return (
              <Fade key={path.id} delay={0.04 * i}>
                <div className="bg-[#1a1f2e] border border-[#2a3347] rounded-2xl p-6 flex flex-col hover:border-[#00ff9d]/50 hover:shadow-xl hover:scale-[1.02] transition-all duration-300">
