      ...
      <AnimatePresence mode="wait">
        ...
        {selectorStep === 0 && (
          <motion.div key="start" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }}>
            <button
              onClick={handleStart}
              className="group flex items-center gap-4 px-6 py-4 md:px-8 md:py-5 rounded-2xl border border-[#2A2A2C] bg-[#161618] hover:border-[#3A3A3F] transition-all w-full sm:w-auto"
                ...
                {currentQuestion.options.map((opt) => {
                  ...
                  return (
                    <button
                      ...
                      className={`text-left p-4 md:p-5 rounded-xl border transition-all duration-200 ${selected ? 'border-[#3A3A3F] bg-[#1A1A1D]' : 'border-[#2A2A2C] bg-[#161618] hover:border-[#3A3A3F]'}`}
              ...
              {currentQuestion.id === 'goals' && (
                <div className="mt-5 md:mt-6 flex justify-end">
                  <button
                    ...
                    className="px-5 py-2.5 md:px-6 md:py-3 rounded-xl font-semibold text-sm transition-all disabled:opacity-30 disabled:cursor-not-allowed"
            ...
            <div className="bg-[#131315] border border-[#2A2A2C] rounded-2xl md:rounded-3xl overflow-hidden" style={{ boxShadow: `0 0 60px ${partner.primaryColor}10` }}>
              ...
              <div className="p-6 md:p-10 flex flex-col sm:flex-row gap-3 md:gap-4">
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 px-6 py-3.5 md:px-8 md:py-4 rounded-xl font-semibold text-base transition-all hover:scale-[1.02]"
                ...
                <button
                  ...
                  className="px-6 py-3.5 md:py-4 rounded-xl font-medium text-base text-[#71717A] border border-[#2A2A2C] hover:border-[#3A3A3F] transition-all"
                >
                  Reset Selection
                </button>
              </div>
