    ...
    <section className="py-24 md:py-32 bg-[#0a0d12]" id="rate-card">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.15 }} className="text-base md:text-lg text-[#9ca3af] mb-12 max-w-3xl">
          Golf Digest digital sells at roughly $50 CPM and a third of that impression is wasted on non golfers. We sell verified golfer impressions starting at $40 CPM with zero waste. Same quality reach. Half the effective cost.
        </motion.p>
